...
export function StandardsPopup() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end justify-center bg-charcoal/60 p-0 backdrop-blur-sm md:items-center md:p-4">
      <div className="w-full max-w-md animate-rise rounded-t-3xl bg-white p-6 shadow-2xl md:rounded-3xl">
        ...
        <h2 className="font-display text-xl font-extrabold text-charcoal">Before you whisper&hellip;</h2>
        ...
        <button
          type="button"
          onClick={dismiss}
          className="mt-6 w-full rounded-full bg-charcoal py-3.5 text-sm font-bold text-off-white transition-transform active:scale-[0.98]"
        >
          Got it, I'm in
        </button>
      </div>
